  ...
  return (
    <>
      ...
      <div className='about'>
        ...
        <a className={"mt-2 anchor-link"} href={"#"} target="_blank" rel="noopener noreferrer">Star our Github Repo</a>
        <a className={"mt-2 anchor-link"} href={"#"} target="_blank" rel="noopener noreferrer">Hack-R-Play Website</a>
      </div>
    </>
  )
}
